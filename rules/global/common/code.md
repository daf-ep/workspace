...
This is the rule that demands the most discipline, because it plays out at the moment you're in a hurry. When `.claude/injectable/code.md` exists, it says how many uses this project tolerates before sharing; the number that follows is the one that applies by default.
